...
describe('TextInput', () => {
  it('renders input with placeholder and value', () => {
    render(<TextInput placeholder="Enter your name" value="John Doe" onChange={() => {}} />);
  ...
  it('calls onChange handler when typing in input', () => {
    ...
    render(<TextInput placeholder="Type here" value="" onChange={handleChange} />);
  ...
  it('renders a label when provided', () => {
    render(<TextInput label="Your Email" name="email" value="" onChange={() => {}} />);

    expect(screen.getByLabelText(/your email/i)).toBeInTheDocument();
  });

  it('displays an error message when error is present', () => {
    render(<TextInput error="This field is required" value="" onChange={() => {}} />);
