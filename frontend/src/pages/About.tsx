	...
	return (
		<div className="h-full flex flex-col bg-secondary text-primary-one px-4 sm:px-6 md:px-20 md:space-y-8 py-4">
			<section className="max-w-5xl mx-auto">
				<Tile
					title={
						<h1 className="text-3xl font-bold mb-6 text-primary sm:text-4xl">
							About Dash
						</h1>
					}
					description={
						<p className="sm:text-lg">
							Welcome to <span className="font-bold">Dash</span> — your one-stop
							destination for premium eCommerce experiences. We provide a
							seamless and intuitive platform where customers can discover,
							explore, and purchase quality products with ease.
						</p>
					}
				/>
					...
					<Tile
						...
						description={
							<ul className="w-fit list-disc list-inside space-y-1 text-left">
								<li>
									Curated product collections across beauty, electronics,
									fashion, and more
								</li>
								<li>Secure and fast checkout with multiple payment options</li>
								<li>
									Responsive customer support and flexible return policies
								</li>
